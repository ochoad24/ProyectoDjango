...
;(function (global, factory) {
    ...
    var defaultLocaleWeekdays = 'Domingo_Lunes_Martes_Miércoles_Jueves_Viernes_Sábado'.split('_');
    ...
    var defaultLocaleWeekdaysShort = 'Dom_Lun_Mar_Mié_Jue_Vie_Sáb'.split('_');
    function localeWeekdaysShort (m) {
        return (m === true) ? shiftWeekdays(this._weekdaysShort, this._week.dow)
            : (m) ? this._weekdaysShort[m.day()] : this._weekdaysShort;
    }

    var defaultLocaleWeekdaysMin = 'Do_Lu_Ma_Mi_Ju_Vi_Sá'.split('_');
